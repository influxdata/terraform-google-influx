module github.com/gruntwork-io/terraform-google-influx/test

go 1.15

require (
	cloud.google.com/go v0.35.1 // indirect
	github.com/aws/aws-sdk-go v1.19.30 // indirect
	...
	k8s.io/client-go v0.0.0-20190228133956-77e032213d34 // indirect
