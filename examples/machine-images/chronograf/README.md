...
1. Update the `variables` section of the `chronograf.json` Packer template to specify the GCP region and zone, and Chronograf version you wish to use.
1. To build an Ubuntu image for Chronograf, run `packer build chronograf.json`.
